<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" wire:submit.prevent="addUser" id="addUserForm" enctype="multipart/form-data">
          <div class="mb-3">
